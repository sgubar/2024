...
void display()
{
    ...
    // Малювання об'єкта – куба з гранями різного кольору
     // Куб складається з 6 квадратів (чотирикутників)
     glBegin(GL_TRIANGLES);
    // Верхня грань (y = 1.0f)
    glColor3f(0.0f, 1.0f, 0.0f); // Зелена
    glVertex3f(sqrt(3)/2, 1.0f, 0.5f);  // Перша вершина трикутника
    glVertex3f(-sqrt(3)/2, 1.0f, 0.5f);  // Друга вершина трикутника
