...
void display()
{
    ...
    glBegin(GL_TRIANGLES); // Призма складається з 2-х трикутників та 3-х прямокутників
...
{
    glutPostRedisplay(); // Генерування запиту на перемалювання сцени викликає функцію display()
