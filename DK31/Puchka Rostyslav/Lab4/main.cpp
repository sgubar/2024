...
int main(int argc, char* argv[])
{
    ...
    Point* points2[4];
    Point* points3[4];
    Figure_s *figure1, *figure2, *figure3;

    // Створимо список фігур
    figlist = createFigList();

    // Створимо фігури і додамо їх до списку
    points1[0] = createPoint(0, 0);
    points1[1] = createPoint(0, 50);
    points1[2] = createPoint(30, 50);
    points1[3] = createPoint(30, 0);
    ...
    points2[2] = createPoint(-30, -60);
    points2[3] = createPoint(0, -60);
    figure2 = createFigure(points2, createColor(1.0, 1.0, 1.0));

    addFigToFigList(figlist, figure2);

    points3[0] = createPoint(-40, -10);
    points3[1] = createPoint(-40, -40);
    points3[2] = createPoint(-70, -40);
    points3[3] = createPoint(-70, -10);
    figure3 = createFigure(points3, createColor(0.9, 0.5, 0.2));
